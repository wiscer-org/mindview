...
__export(colors_exports, {
  randomSimilarColorPair: () => randomSimilarColorPair,
  similarColors: () => similarColors,
  similarColorsAdvanced: () => similarColorsAdvanced
});
var similarColors = [
  ["red", "pink"],
  ["red", "orange"],
...
var similarColorsAdvanced = [
  ["teal", "turquoise"],
  ["orange", "coral"],
  ["purple", "violet"],
  ["brown", "sienna"]
];
function randomSimilarColorPair() {
...
// similar-colors/src/similar-colors.ts
...
var SimilarColors = class extends Game {
  constructor() {
    super();
    this.upperHalfRect = "U" /* UPPER */;
    this.colorPair = ["black", "white"];
  ...
  newGame() {
    ...
    this.colorPair = libs.colors.randomSimilarColorPair();
    this.drawCanvas();
  }
  drawCanvas() {
  ...
  randomizeUpperHalfRect() {
    ...
    this.upperHalfRect = values[randomIndex];
  }
  getAssetsToLoad() {
    return [];
  }
...
SimilarColors.colors = ["red", "blue", "green", "yellow", "orange", "purple", "pink", "brown", "gray", "black", "white"];
var UpperHalfRect = /* @__PURE__ */ ((UpperHalfRect2) => {
  UpperHalfRect2["UPPER_LEFT"] = "UL";
  UpperHalfRect2["UPPER_RIGHT"] = "UR";
  UpperHalfRect2["UPPER"] = "U";
  UpperHalfRect2["LEFT"] = "R";
  return UpperHalfRect2;
})(UpperHalfRect || {});
